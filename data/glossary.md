...
| NHP Completion Rate (D7) | % of team members sent an NHP who complete it within 7 days. Current avg: ~52% trailing 3 months. H1 2026 target: 70%+. Distinct from `hrdocs_engaged_boolean` (different threshold). | `postgres.employee_onboarding_packets` | [hrm/hrm.md](product-areas/hrm/hrm.md) | HRM | Onboarding |
...
| Invite → Login Rate (D7) | % of invited Employees who log in for the first time within 7 days of invite. Avg ~77% trailing 12 months. Currently tracked at Job level; migrating to Team Member level — do not blend historical with future data. H1 2026 target: 87%+. | `postgres.jobs` | [hrm/hrm.md](product-areas/hrm/hrm.md) | HRM | Onboarding |
